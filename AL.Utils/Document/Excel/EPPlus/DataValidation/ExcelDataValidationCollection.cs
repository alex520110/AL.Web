...
using AL.Utils.EPPlus.Utils;
using System.Xml;
using AL.Utils.EPPlus.DataValidation.Contracts;

namespace AL.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit AL.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
