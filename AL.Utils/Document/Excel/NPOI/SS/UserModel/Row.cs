...
namespace AL.Utils.NPOI.SS.UserModel
{
    ...
    public interface IRow
    {
        ...
        /// (255 for *.xls, 1048576 for *.xlsx)
        /// </throws>
        ICell CreateCell(int column, AL.Utils.NPOI.SS.UserModel.CellType type);
        ...
        /// <see cref="GetCell(int, AL.Utils.NPOI.SS.UserModel.MissingCellPolicy)"/>
        ICell GetCell(int cellnum);

        /// <summary>
        /// Returns the cell at the given (0 based) index, with the specified {@link AL.Utils.NPOI.SS.usermodel.Row.MissingCellPolicy}
        /// </summary>
