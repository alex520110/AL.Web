...
namespace AL.Utils.NPOI.SS.Util
{
    using System;
    ...
    public class SheetUtil
    {
         ...
         *  {@link AL.Utils.NPOI.SS.UserModel.DataFormatter#formatCellValue(AL.Utils.NPOI.SS.UserModel.Cell)}
        ...
        public static double GetColumnWidth(ISheet sheet, int column, bool useMergedCells)
        {
            ...
            using (Bitmap bmp = new Bitmap(2048, 100))
            {
                ...
                for (IEnumerator it = sheet.GetRowEnumerator(); it.MoveNext(); )
                {
                    ...
                    AL.Utils.NPOI.SS.UserModel.IFont font1 = wb.GetFontAt(style.FontIndex);
