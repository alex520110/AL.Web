...
namespace AL.Utils.NPOI.Util
{
    ...
    /// the header has been written.  The client code can call <see cref="M:AL.Utils.NPOI.Util.IDelayableLittleEndianOutput.CreateDelayedOutput"/>
