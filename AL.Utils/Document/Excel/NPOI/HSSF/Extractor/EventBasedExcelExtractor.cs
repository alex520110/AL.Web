...
namespace AL.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using AL.Utils.NPOI;
    using AL.Utils.NPOI.HPSF;
    using AL.Utils.NPOI.SS.Formula.Eval;
    using AL.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (AL.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            AL.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = AL.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
