...
namespace AL.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using AL.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static AL.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            AL.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static AL.Utils.NPOI.SS.UserModel.ICell GetCell(AL.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            AL.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static AL.Utils.NPOI.SS.UserModel.ICell CreateCell(AL.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            AL.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static AL.Utils.NPOI.SS.UserModel.ICell CreateCell(AL.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(AL.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            AL.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            AL.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                AL.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(AL.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                AL.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (AL.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (AL.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (AL.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (AL.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (AL.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (AL.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (AL.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
