...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,AL.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, AL.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(AL.Utils.NPOI.SS.UserModel.IFont font)
        {
