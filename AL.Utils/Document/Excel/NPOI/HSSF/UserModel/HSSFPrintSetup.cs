...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :AL.Utils.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public AL.Utils.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (AL.Utils.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
