...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    [Serializable]
    public class HSSFTextbox : HSSFSimpleShape //,AL.Utils.NPOI.SS.UserModel.ITextbox
    {
    ...
    public static short  VERTICAL_ALIGNMENT_DISTRIBUTED= 7;
        ...
        AL.Utils.NPOI.SS.UserModel.IRichTextString str = new HSSFRichTextString("");
        ...
        public virtual AL.Utils.NPOI.SS.UserModel.IRichTextString String
        {
            get { return str; }
            set
