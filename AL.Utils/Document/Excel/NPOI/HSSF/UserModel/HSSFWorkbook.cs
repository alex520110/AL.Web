...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    using AL.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public AL.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : AL.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private AL.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = AL.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public AL.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            AL.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public AL.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public AL.Utils.NPOI.SS.UserModel.Font FindFont(AL.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 AL.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, AL.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public AL.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                AL.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public AL.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public AL.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public AL.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, AL.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case AL.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case AL.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case AL.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case AL.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case AL.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case AL.Utils.NPOI.SS.UserModel.PictureType.DIB:
