...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    using AL.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)AL.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)AL.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
