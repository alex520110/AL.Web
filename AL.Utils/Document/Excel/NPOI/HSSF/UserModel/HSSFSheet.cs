...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using AL.Utils.NPOI.DDF;
    using AL.Utils.NPOI.HSSF.Model;
    using AL.Utils.NPOI.HSSF.Record;
    using AL.Utils.NPOI.HSSF.Record.Aggregates;
    using AL.Utils.NPOI.HSSF.Record.AutoFilter;
    using AL.Utils.NPOI.HSSF.Util;
    using AL.Utils.NPOI.SS;
    using AL.Utils.NPOI.SS.Formula;
    using AL.Utils.NPOI.SS.Formula.PTG;
    using AL.Utils.NPOI.SS.UserModel;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : AL.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, AL.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="AL.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, AL.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="AL.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(AL.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public AL.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            AL.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public AL.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(AL.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(AL.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public AL.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    AL.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new AL.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="AL.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public AL.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, AL.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, AL.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, AL.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, AL.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, AL.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                AL.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                AL.Utils.NPOI.SS.Util.CellRangeAddress region = (AL.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(AL.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    AL.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, AL.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, AL.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public AL.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(AL.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(AL.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public AL.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, AL.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                AL.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public AL.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                AL.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
