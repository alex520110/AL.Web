...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private AL.Utils.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(AL.Utils.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(AL.Utils.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            AL.Utils.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public AL.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public AL.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
