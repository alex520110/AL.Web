...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:AL.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, AL.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
