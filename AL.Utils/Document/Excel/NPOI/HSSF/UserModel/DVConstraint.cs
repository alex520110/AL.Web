...
namespace AL.Utils.NPOI.HSSF.UserModel
{
    ...
    public class DVConstraint : IDataValidationConstraint
    {
         ...
         * 
         * @param validationType one of {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#ANY},
         * {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#DECIMAL},
         * {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#INTEGER},
         * {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
         * @param comparisonOperator any constant from {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
         ...
         * 
         * @param comparisonOperator constant from {@link AL.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
        ...
        /* (non-Javadoc)
         * @see AL.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getValidationType()
         */
        ...
        /* (non-Javadoc)
         * @see AL.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula1()
         */
        ...
        /* (non-Javadoc)
         * @see AL.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula2()
         */
