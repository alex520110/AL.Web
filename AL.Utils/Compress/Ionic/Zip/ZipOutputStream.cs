...
// generating zip files.  This class does not depend on AL.Utils.Ionic.Zip.ZipFile, but rather
...
namespace AL.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = AL.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="AL.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = AL.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="AL.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private AL.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public AL.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
