...
namespace AL.Utils.Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="AL.Utils.Ionic.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new AL.Utils.Ionic.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= AL.Utils.Ionic.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = AL.Utils.Ionic.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = AL.Utils.Ionic.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
