...
namespace AL.Utils.Ionic.Zip
{
    ...
    ///   cref="AL.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="AL.Utils.Ionic.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.SetCompression"/>
    public delegate AL.Utils.Ionic.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
