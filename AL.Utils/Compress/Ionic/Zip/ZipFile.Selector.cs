...
namespace AL.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            AL.Utils.Ionic.FileSelector ff = new AL.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace AL.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(AL.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(AL.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(AL.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<AL.Utils.Ionic.Zip.ZipEntry> SelectEntries(AL.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<AL.Utils.Ionic.Zip.ZipEntry>();

            foreach (AL.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<AL.Utils.Ionic.Zip.ZipEntry> SelectEntries(AL.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
