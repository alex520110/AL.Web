...
namespace AL.Utils.Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        ///
        /// using(AL.Utils.Ionic.Zip.ZipFile zip = new AL.Utils.Ionic.Zip.ZipFile())
        /// {
        ...
        /// </remarks>
        ///
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="AL.Utils.Ionic.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
