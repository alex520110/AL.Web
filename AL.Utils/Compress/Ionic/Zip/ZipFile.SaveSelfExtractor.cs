...
namespace AL.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public AL.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "AL.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "AL.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "AL.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace AL.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the AL.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  AL.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("AL.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the AL.Utils.Ionic.Zip
                        ...
                        // add the AL.Utils.Ionic.Utils.Zip DLL as an embedded resource
