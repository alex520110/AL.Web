...
using AL.Utils.Ionic.Zlib;
using System.IO;


namespace AL.Utils.Ionic.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        AL.Utils.Ionic.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="AL.Utils.Ionic.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="AL.Utils.Ionic.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private AL.Utils.Ionic.Crc.CRC32             _runningCrc;
        ...
        private AL.Utils.Ionic.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="AL.Utils.Ionic.Zlib.DeflateStream"/>,
        ...
        ///   cref="AL.Utils.Ionic.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new AL.Utils.Ionic.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="AL.Utils.Ionic.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    AL.Utils.Ionic.Zlib.CRC32 c= new AL.Utils.Ionic.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                AL.Utils.Ionic.Crc.CRC32 crc = new AL.Utils.Ionic.Crc.CRC32();
