...
using AL.Utils.ZipLib.Encryption;
#endif

using AL.Utils.ZipLib.Core;
using AL.Utils.ZipLib.Checksums;
using AL.Utils.ZipLib.Zip.Compression.Streams;
using AL.Utils.ZipLib.Zip.Compression;

namespace AL.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="AL.Utils.ZipLib.Zip.ZipException">
