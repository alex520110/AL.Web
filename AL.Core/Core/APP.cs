...
namespace AL.Core
{
    public class APP
    {
        ...
        //BLL的一些设置
        public static string SERVICE_BLL_NAMESPACE = "AL.Models"; //指定bll层的命名空间
        public static string SERVICE_BLL_FILE_NAME = "AL.Web"; //指定bll层所在的dll名称，如AL.BLL.dll 则值为AL.BLL
